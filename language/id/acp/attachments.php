 ...
 * @package language
 * @version $Id: attachments.php 2017 harissaids@gmail.com
...
$lang = array_merge($lang, array(
	...
	'ATTACH_POST_ID'					=> 'Posting ID',
	'ATTACH_POST_TYPE'					=> 'Jenis Posting',
	...
	'DEFINE_ALLOWED_IPS'			=> 'Masukkan alamat IP/nama host yang diizinkan',
	'DEFINE_DISALLOWED_IPS'			=> 'Masukkan alamat IP/nama host yang tidak diizinkan',
	...
	'EXCLUDE_FROM_ALLOWED_IP'		=> 'Singkirkan alamat IP atau nama host yang diizinkan',
	'EXCLUDE_FROM_DISALLOWED_IP'	=> 'Singkirkan alamat IP atau nama host yang tidak diizinkan',
	...
	'FILES_GONE'			=> 'Beberapa file yang dipilih untuk dihapus tidak ada. File tersebut kemungkinan telah dihapus sebelumnya. Hanya file yang ada yelah dihapus.',
	'FILES_STATS_WRONG'		=> 'Statistik file Anda kemungkinan tidak akurat dan diperlukan sinkronisasi ulang. Nilai sebenarnya: Jumlah lampiran = %1$d, Jumlah ukuran total = %2$s.<br />Klik %3$shere%4$s untuk sinkronisasi ulang.',
	...
	'NOT_ALLOWED_IN_PM_POST'	=> 'Tidak diizinkan',
	'NOT_ASSIGNED'				=> 'Belum ditetapkan',
	'NO_ATTACHMENTS'			=> 'Tidak Ada lapimpiran dalam masa ini.',
	...
	'NO_WRITE_UPLOAD'			=> 'Direktori untuk upload yang anda tentukan tidak bisa ditulis. Silahkan mengubah perizinan agar webserver dapat menulis ke direktori tersebut.',

	'ONLY_ALLOWED_IN_PM'	=> 'Ijinkan hanya di pesan pribadi saja',
	'ORDER_ALLOW_DENY'		=> 'Ijinkan',
	'ORDER_DENY_ALLOW'		=> 'Abaikan',

	'REMOVE_ALLOWED_IPS'		=> 'Singkirkan IP/nama host <em>yang diizinkan</em>',
	'REMOVE_DISALLOWED_IPS'		=> 'Singkirkan IP/nama host <em>yang tidak diizinkan</em>',
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Anda yakin untuk mengsinkronisasi ulang statistik file?',

	'SEARCH_IMAGICK'				=> 'Cari Imagemagick',
	'SECURE_ALLOW_DENY'				=> 'Daftar yang diizinkan/diabaikan',
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Ubah sifat default pada saat secure download diizinkan dari daftar yang diizinkan/diabaikan menjadi sebuah <strong>daftar putih</strong> (yang dizinkan) atau <strong>daftar hitam</strong> (yang diabaikan).',
	...
	'SECURE_DOWNLOAD_NOTICE'		=> 'Secure Downloads tidak diizinkan. Pengaturan ini hanya berguna setelah mengizinkan secure downloads.',
