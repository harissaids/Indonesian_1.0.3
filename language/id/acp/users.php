 ...
 * @package language
 * @version $Id: users.php 2017 harissaids@gmail.com
...
$lang = array_merge($lang, array(
	...
	'CANNOT_BAN_ANONYMOUS'         	=> 'Anda tidak diizinkan melarang akun anonim. perizinan untuk pengguna anonim bisa diatur di tab perizinan.',
	'CANNOT_BAN_FOUNDER'			=> 'Anda tidak diizinkan untuk melarang account pendiri.',
	'CANNOT_BAN_YOURSELF'			=> 'Anda tidak diizinkan untuk melarang diri anda sendiri.',
	'CANNOT_DEACTIVATE_BOT'			=> 'Anda tidak diizinkan untuk menonaktifkan accout bot. Silahkan nonaktifkan bot tersebut dari halaman bot.',
	'CANNOT_DEACTIVATE_FOUNDER'		=> 'Anda tidak diizinkan untuk menonaktifkan account pengguna.',
	'CANNOT_DEACTIVATE_YOURSELF'	=> 'Anda tidak diizinkan untuk menonaktifkan account anda sendiri.',
	'CANNOT_FORCE_REACT_BOT'		=> 'Anda tidak diizinkan untuk memaksakan pengaktifan kembali untuk account bot. Silahkan aktifkan kembali bot tersebut dari halaman bot.',
	'CANNOT_FORCE_REACT_FOUNDER'	=> 'Anda tidak diizinkan untuk memaksakan pengaktifan kembali untuk account pendiri.',
	'CANNOT_FORCE_REACT_YOURSELF'	=> 'Anda tidak diizinkan untuk memaksakan pengaktifan kembali untuk account anda.',
	'CANNOT_REMOVE_ANONYMOUS'		=> 'Anda tidak dapat menyingkirkan account tamu.',
	'CANNOT_REMOVE_FOUNDER'			=> 'Anda tidak diizinkan menyingkirkan akun pendiri.',
	...
	'FOUNDER'						=> 'Pendiri',
	'FOUNDER_EXPLAIN'				=> 'Pendiri memiliki semua perizinan administrasi dan tidak bisa dilarang, dihapus ataupun diubah oleh anggota yang bukan pendiri.',
	...
	'USER_AVATAR_NOT_ALLOWED'		=> 'Avatar yang sekarang tidak bisa ditampilkan karena avatar tersebut tidak diizinkan.',
	'USER_AVATAR_UPDATED'			=> 'Keterangan avatar pengguna telah berhasil diperbarui.',
	'USER_AVATAR_TYPE_NOT_ALLOWED'	=> 'Avatar yang sekarang tidak bisa ditampilkan karena tipe avatar tersebut tidak diizinkan.',
	...
	'USER_NO_POSTS_TO_DELETE'			=> 'Pengguna ini tidak memiliki posting untuk diambil atau dihapus.',
	...
	'USER_POSTS_MOVED'				=> 'Posting-post pengguna telah berhasil dipindahkan ke forum target.',
