...
$lang = array_merge($lang, array(
	...
	'PM_MAX_RECIPIENTS'			=> 'Jumlah maksimum penerima yang diizinkan',
	'PM_MAX_RECIPIENTS_EXPLAIN'	=> 'Jumlah maksimum anggota yang diizinkan dalam sebuah pesan pribadi. Jika nilai yang dimasukkan 0 maka jumlah anggota yang diizinkan menjadi tidak terbatas. Pengaturan ini dapat dibuat untuk setiap grup pada halaman pengaturan grup.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_POST_LINKS_EXPLAIN'			=> 'Jika <code>[URL]</code> BBCode tidak diizinkan maka URL otomatis juga tidak dapat digunakan.',
	...
	'CHAR_LIMIT_EXPLAIN'			=> 'Jumlah karakter yang diizinkan dalam sebuah post. Gunakan nilai 0 untuk tidak membatasi jumlah karakter.',
	...
	'MAX_POST_FONT_SIZE_EXPLAIN'	=> 'Ukuran maksimum huruf yang diizinkan di post. Gunakan 0 untuk ukuran huruf yang tidak terbatas.',
...
$lang = array_merge($lang, array(
	...
	'MAX_SIG_FONT_SIZE_EXPLAIN'		=> 'Ukuran huruf maksimum yang diizinkan dalam tanda tangan pengguna. Gunakan 0 untuk ukuran huruf yang tidak terbatas.',
	...
	'MAX_SIG_SMILIES_EXPLAIN'		=> 'Jumlah maksimum tanda Smiley yang diizinkan dalam tanda tangan pengguna. Gunakan 0 untuk jumlah tanda Smiley yang tidak terbatas.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Anggota baru yang termasuk grup <em>Pengguna Terdaftar Terbaru</em> sampai mereka mencapai jumlah post ini. Anda bisa menggunakan grup ini agar bisa menjaga penggunaan sistem PM ataupun meninjau pesan mereka. <strong>Nilai 0 untuk menonaktifkan fitur ini.</strong>',
...
$lang = array_merge($lang, array(
	...
	'IP_VALID_EXPLAIN'				=> 'Menentukan berapa banyak IP pengguna untuk mengesahkan sesi; <samp>Semua</samp> membandingkan alamat lengkap, <samp>A.B.C</samp> pertama x.x.x, <samp>A.B</samp> pertama x.x, <samp>Tidak</samp> menonaktifkan pemeriksaan. Pada alamat IPv6 <samp>A.B.C</samp> membandingkan 4 blok pertama dan <samp>A.B</samp> 3 blok pertama.',
       ...
       'IP_LOGIN_LIMIT_MAX_EXPLAIN'   			=> 'Batas ambang percobaan masuk yang diizinkan dari sebuah alamat IP tunggal sebeum anti-spambot digunakan. Masukkan 0 untuk mencegah penggunaan anti-spambot yang disebabkan oleh alamat IP.',
