...
$lang = array_merge($lang, array(
	...
	'AVATAR_TYPE_NOT_ALLOWED'		=> 'Avatar Anda saat ini tidak dapat ditampilkan karena jenisnya telah dianulir.',
	...
	'CLICK_GOTO_FOLDER'         => '%1$s Ke folder “%3$s” anda%2$s',
	'CLICK_RETURN_FOLDER'		=> '%1$sKembali ke folder “%3$s” anda %2$s',
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Untuk mengganti kata sandi, alamat email, atau nama pengguna Anda, Anda harus memasukkan kata sandi Anda saat ini.',
	'CUR_PASSWORD_EMPTY'		=> 'Anda tidak memasukkan kata sandi Anda saat ini.',
	...
	'DEFAULT_SMILIES'			=> 'Bolehkan Smiley(smily) sebagaimana adanya',
	...
	'FIELD_INVALID_CHARS_INVALID'		=> 'Isian ini “%s” tidak memiliki karakter sah.',
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya angka yang diizinkan.',
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya alpanumerik atau . karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya alpanumerik karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya alpanumerik atau _,-. karakter yang diizinkan dan karakter pertama dimulai dengan abjad.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya alpanumerik, spasi atau -+_[] karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya alpanumerik atau _ karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya huruf, angka atau . karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya huruf dan angka karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Isian ini “%s” tidak memiliki karakter sah, hanya huruf, angka atau _,-. karakter yang diperbolehkan dan karakter pertama dimulai dengan abjad.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'The field “%s” tidak memiliki karakter sah, hanya letter, angka,spasi atau -+_[] karakter yang diizinkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'The field “%s” tidak memiliki karakter sah, hanya letter, angka atau _ karakter yang diizinkan.',
	'FIELD_INVALID_DATE'				=> 'Isian ini “%s” tidak memiliki tanggal yang sah.',
	'FIELD_INVALID_URL'					=> 'Isian ini “%s” tidak memiliki url yang.',
	...
	'FOLDER_STATUS_MSG'			=> array(
		1	=> 'Folder %3$d%% Penuh (%2$d dari %1$s tersimpan)',
		2	=> 'Folder %3$d%% Penuh (%2$d dari %1$s tersimpan)',
	),
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Masukan alamat email yang Anda gunakan untuk mendaftarkan Akun di <a href="http://www.gravatar.com/">Gravatar</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Dimensi Avatar',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Tentukan dimensi lebar dan tinggi Avatar, kosongkan untuk mencoba secara otomatis.',
	...
	'LOGIN_LINK'					=> 'Tautan atau link registrasi akun Anda di Layanan lain dengan akun forum Anda',
	'LOGIN_LINK_EXPLAIN'			=> 'Anda telah mencoba untuk masuk ke layanan eksternal yang belum terkoneksi dengan Akun Anda di forum ini. Sekarang Anda harus menghubungkan akun tersebut atau membuat akun baru.',
	'LOGIN_LINK_MISSING_DATA'		=> 'Data yang diperlukan untuk menghubungkan Akun Anda dengan layanan eksternal tidak tersedia. Harap kembali mencoba proses masuk (login).',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Kesalahan terjadi pada saat pemindahan pesan ke folder yang baru, hanya %2$d dari %1$s pesan yang dipindahkan.',
		2	=> 'Kesalahan terjadi pada saat pemindahan pesan ke folder yang baru, hanya %2$d dari %1$s pesan yang dipindahkan.',
	),
	...
	'NEW_PASSWORD_CONFIRM_EMPTY'	=> 'Anda tidak memasukkan kata sandi.',
	'NEW_PASSWORD_ERROR'			=> 'Kara kunci yang masukkan tidak cocok.',

	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Tandai semua pemberitahuan terbaca',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Yakin Anda ingin menandainya??',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'Semua pemberitahuan telah terbaca.',
	'NOTIFICATION_GROUP_MISCELLANEOUS'					=> 'Pemberitahuan lain-lain',
	'NOTIFICATION_GROUP_MODERATION'						=> 'Pemberitauan Moderator',
	'NOTIFICATION_GROUP_ADMINISTRATION'					=> 'Pemberitahuan Administrator',
	'NOTIFICATION_GROUP_POSTING'						=> 'Pemberitahuan Posting',
	'NOTIFICATION_METHOD_BOARD'							=> 'Pemberitahuan',
	'NOTIFICATION_METHOD_EMAIL'							=> 'Email',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'Tipe Pemberitahuan',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Seseorang membalas ke topik yang Anda bookmark',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Seseorang meminta izin untuk ikut di grup yang Anda pimpin',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'Sebuah posting atau topik memerlukan persetujuan',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Topik/Posting Anda akan disetujuai atau ditolak oleh Moderator',
	'NOTIFICATION_TYPE_PM'								=> 'Seseorang telah mengirimkan Anda Pesan pribadi',
	'NOTIFICATION_TYPE_POST'							=> 'Seseorang membalas topik yang Anda berlangganan',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Seseorang telah mengutip Anda dalam sebuah posting',
	'NOTIFICATION_TYPE_REPORT'							=> 'Seseorang melaporkan posting',
	'NOTIFICATION_TYPE_TOPIC'							=> 'Seseorang telah membuat topik di forum yang Anda berlangganan',
	...
	'NOT_MOVED_MESSAGES'			=> array(
		1	=> 'Anda memiliki %d pesan pribadi yang sekarang ini ditahan karena folder penuh.',
	...
	'NO_AVATAR'						=> 'Tidak Ada Avatar yg dipilih',
	...
	'NO_AUTH_PROFILEINFO'			=> 'Anda tidak berhak untuk mengganti Informasi di profile Anda.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s sampai %2$s karakter, harus mengandung pencampuran huruf besar dan kecil dan harus mengandung angka.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Panjang kata sandi harus diantara %1$s dan %2$s karakter.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s sampai %2$s karakter dan harus mengandung pencampuran huruf besar dan kecil.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s sampai %2$s karakter, harus mengandung pencampuran huruf besar dan kecil, harus mengandung angka dan harus mengandung angka symbol.',
	'PASSWORD'					=> 'Kata sandi',
	...
	'PERMISSIONS_RESTORED'		=> 'Berhasil mengembalikan perizinan yang asli.',
	'PERMISSIONS_TRANSFERRED'	=> 'Berhasil memindahkan perizinan dari <strong>%s</strong>, sekarang anda dapat menelusuri halaman dengan perizinan pengguna ini.<br />Harap dicatat bahwa ijin administrator tidak ditransfer. Anda dapat kembali pada pengaturan perizinan anda setiap waktu.',
	...
	'PM_MARK_ALL_READ'			=> 'Semua pesan ditandai terbaca',
	'PM_MARK_ALL_READ_SUCCESS'	=> 'Semua pesan di folder ini telah ditandai terbaca',
	...
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Beberapa pengguna tidak dapat ditambahkan sebagimana mereka tidak memperbolehkan penerimaan pesan pribadi.',

	'PM_USERS_REMOVED_NO_PM'	=> 'Beberapa pengguna tidak dapat ditambahkan karena mereka menonaktifkan fitur pesan pribadi.',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Login key "Ingat saya" adalah fitur yang akan memasukkan Anda saat berkunjung ke situs ini dengan otomatis. Jika Anda keluar, login key dihapus dari komputer yang Anda gunakan. Disini Anda dapat melihat sejarah login key yang pernah dibuat berikut nama komputer saat Anda mengakses situs ini.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Tidak Ada login key "Ingat Saya" yang tersimpan.',
	...
	'RULE_LIMIT_REACHED'				=> 'Anda tidak dapat menambah peraturan PM,. Peraturan PM Anda telah sampai pada batas maksimum.',
	'RULE_NOT_DEFINED'					=> 'Peraturan tidak ditentukan dengan benar.',
	'RULE_REMOVED_MESSAGES'				=> array(
		1	=> '%d pesan pribadi disingkirkan yang berkaitan dengan penyaringan pesan.',
	...
	'SELECT_CURRENT_TIME'		=> 'Pilih waktu saat ini',
	...
	'TIMEZONE_INVALID'			=> 'Zona waktu yang Anda pilih tidak valid.',
	'TO'						=> 'Penerima',
	'TO_MASS'					=> 'Beberapa penerima',
	'TO_ADD'					=> 'Tambah penerima',
	'TO_ADD_MASS'				=> 'Tambah beberapa penerima',
	'TO_ADD_GROUPS'				=> 'Tambah grup',
	...
	'UCP_AUTH_LINK'				=> 'Akun eksternal',
	'UCP_AUTH_LINK_ASK'			=> 'Saat ini Anda tidak mempunyai akun yang berhubungan dengan layanan ekternal ini. Klik tombol dibawah ini untuk menghubngkan akun Anda ini dengan Akun layanan eksternal.',
	'UCP_AUTH_LINK_ID'			=> 'ID Unik',
	'UCP_AUTH_LINK_LINK'		=> 'Link',
	'UCP_AUTH_LINK_MANAGE'		=> 'Kelola Akun external',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Mehubungkan Akun ini dengan akun layanan eksternal tidak tersedia di situs ini dengan metode otentifikasi yang ada.',
	'UCP_AUTH_LINK_TITLE'		=> 'Kelola Akun eksternal Anda',
	...
	'UCP_LOGIN_LINK'			=> 'Mengatur akun eksternal',
	...
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'Disini Anda dapat melihat semua pemberitahuan yang ada.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Kelola Login Keys “Ingat Saya"',

	'UCP_USERGROUPS'			=> 'Grup Pengguna',
	'UCP_USERGROUPS_MEMBER'		=> 'Edit keanggotaan',
	'UCP_USERGROUPS_MANAGE'		=> 'Atur grup',

	'UCP_PASSWORD_RESET_DISABLED'	=> 'Fungsi setel ulang kata sandi telah dinon-aktifkakn. Apabila Anda mebutuhkan bantuan dalam mengakses akun, Harap kontak %sBoard Administrator%s',
	...
	'UCP_WELCOME'					=> 'Selamat datang di Pengaturan Papan Pengguna. Dari sini anda dapat memonitor, melihat dan meng-update profil anda, preferensi, subscribed forum dan topik. Anda juga dapat megirim pesan ke user-user (jika diizinkan).  Sebelum melanjutkan, pastikan anda membaca semua pengumuman terlebih dahulu.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Panjang karakter nama pengguna harus diantara %1$s dan %2$s dan hanya menggunakan karakter alphnumeric.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Panjang karakter nama pengguna harus diantara %1$s and %2$s dan hanya menggunakan karakter alphnumeric, spasi atau karakter -+_[].',
	'USERNAME_ASCII_EXPLAIN'		=> 'Panjang karakter nama pengguna harus diantara %1$s and %2$s dan hanya menggunakan karakter ASCII, dan tidak ada simbol spesial.',
	'USERNAME_LETTER_NUM_EXPLAIN'	=> 'Panjang karakter nama pengguna harus diantara %1$s and %2$s dan hanya menggunakan karakter huruf dan angka.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Panjang karakter nama pengguna harus diantaras %1$s and %2$s dan hanya menggunakan karakter, angka, spasi atau karakter -+_[].',
	'USERNAME_CHARS_ANY_EXPLAIN'	=> 'Panjang nama pengguna harus diantara %1$s sampai %2$s karakter.',
	...
	'PM_RULE' => array(
		'IS_LIKE'		=> 'Sama dengan',
		'IS_NOT_LIKE'	=> 'Tak sama',
		'IS'			=> 'Adalah',
		'IS_NOT'		=> 'Bukan',
		'BEGINS_WITH'	=> 'Mulai dengan',
		'ENDS_WITH'		=> 'diakhiri dengan',
		'IS_FRIEND'		=> 'Teman',
		'IS_FOE'		=> 'Lawan',
		'IS_USER'		=> 'pengguna',
		'IS_GROUP'		=> 'Ada di grup pengguna',
		'ANSWERED'		=> 'Terjawab',
		'FORWARDED'		=> 'Diteruskan',
		'TO_GROUP'		=> 'Ke Grup pengguna default saya',
		'TO_ME'			=> 'Kepada saya',
	),
